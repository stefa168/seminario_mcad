...
\begin{frame}{Dimostrazione Correttezza}
    ...
    \begin{block}{Lemma}
        L'algoritmo BenOr garantisce la well-formedness, l'agreement.
    \end{block}
\end{frame}
...
\begin{frame}{Dimostrazione Correttezza (Agreement) (2/2)}
    \begin{enumerate}
        ...
        \begin{itemize}
            \item $P_{j}$ ha ricevuto $n - f$ messaggi ("second", s, v) contenenti lo stesso valore $v$.
            \begin{addmargin}[1em]{2em}
            $\implies$ $P_{j}$ decide $v$ e manda a tutti ("first", s, v). 
            \end{addmargin}
            
            \item $P_{j}$ ha ricevuto $n - 2f \leq k < n - f$ messaggi ("second", s, v) contenenti lo stesso valore $v$.
            \begin{addmargin}[1em]{2em}
            $\implies$ $P_{j}$ setta $x := v$ e manda a tutti ("first", s, v). 
            \end{addmargin}
        \end{itemize}
        
        In ogni caso allo stage successivo $s + 1$ tutti i processo riceveranno almeno $n - f$ messaggi ("first", s + 1, v) e invieranno pertanto un messaggio ("second", s + 1, v), di conseguenza tutti i processi riceveranno $n - f$ messagi ("second", s + 1, v) e decideranno quindi v.
    \end{enumerate}
\end{frame}
...
\begin{frame}{Dimostrazione (3/?): Un solo valore buono}
    \begin{enumerate}
        \setcounter{enumi}{3}
...
\begin{frame}{Dimostrazione (4/?): Un solo valore buono}
    \begin{enumerate}
        \setcounter{enumi}{6}
...
\begin{frame}{Dimostrazione (5/?): Due valori buoni}
    \begin{enumerate}
        \setcounter{enumi}{8}
